...
interface NavSidebarProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  activeScreen: 'SANCTUM' | 'GAME' | 'PANTHEON' | 'WAR' | 'MORTAL_GAMES' | 'CLASH';
}

const NavSidebar: React.FC<NavSidebarProps> = ({ currentGod, onNavigateToSanctum, onNavigateToPantheon, onNavigateToMortalGames, isOpen, onClose, activeScreen }) => {
  ...
  const getLinkClass = (screen: 'SANCTUM' | 'PANTHEON' | 'MORTAL_GAMES') => {
